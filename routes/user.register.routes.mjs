...
router.post('/create-manufacturer', async (req, res)=>{
    ...
    const index = await factory.getManufacturerSize({from : process.env.defaultAccount});
...
router.post('/create-distributor', async (req, res)=>{
    ...
    const index = await factory.getDistributorSize();
...
router.post('/create-retailer', async (req, res)=>{
    ...
    const index = await factory.getRetailerSize();
...
router.post('/create-customer', async (req, res)=>{
    ...
    const index = await factory.getCustomerSize();
